  ...
  return (
    <div className='max-w-[1240px] mx-auto text-center py-24'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 p-4'>
        <InstagramPic socialImg={IgImg1} />
        <InstagramPic socialImg={IgImg2} />
        <InstagramPic socialImg={IgImg3} />
        <InstagramPic socialImg={IgImg4} />
        <InstagramPic socialImg={IgImg5} />
        <InstagramPic socialImg={IgImg6} />
      </div>
    </div>
  );
};
